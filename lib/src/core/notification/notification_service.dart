...
class NotificationService {
  ...
  static String deviceToken = "1111";
  ...
  void _showNotification(RemoteMessage message) async {
    ...
    log('test ${message.data.toString()}');
    log("=== message ===>${ json.encode(message.toMap())}");
    await _flutterLocalNotificationsPlugin.show(notification.hashCode,
        Languages.currentLanguage.languageCode == 'ar'?
        message.data['title_ar'] : message.data['title_en']?? '',
        Languages.currentLanguage.languageCode == 'ar'?
        message.data['body_ar'] : message.data['body_en']?? '',
        notificationDetails,
